...
# plot graph
plot(dt$Date_Time, dt$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "") # plot initial line
points(dt$Date_Time, dt$Sub_metering_2, type = "l", col = "red") # add line
points(dt$Date_Time, dt$Sub_metering_3, type = "l", col = "blue") # add line
# add legend
